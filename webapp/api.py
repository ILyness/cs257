...
def get_marks(gender,event):
    ...
    try:
        ...
        display_number = flask.request.args.get('display_number', default=20,type=int)
            ...
            #initial query, getting all relevant guaranteed information
        ...
        #subquery to get the event category for the specified event, used for sorting and mark filtering
        ...
        #sorts marks according to event category, Running, Multi(decathlon), and Field(throws/jumps)
