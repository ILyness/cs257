...
CREATE TABLE running_performances (
    id integer NOT NULL, 
    mark text,
    wind text,
);

CREATE TABLE field_performances (
    id integer NOT NULL, 
    mark text,
    wind text,
);

CREATE TABLE multi_performances (
    id integer NOT NULL, 
    mark text,
);

CREATE TABLE running_results (  -- keeping this table, as multiple athletes can refer to a single performance (relays)
    ...
    meet_id integer -- REFERS TO meets table id
);

CREATE TABLE field_results (  -- keeping this table, as multiple athletes can refer to a single performance (relays)
    athlete_id integer, --REFERS TO table athletes table id
    performance_id integer, -- REFERS TO performances table id 
    school_id integer, -- REFERS TO schools table id
    event_id integer, -- REFERS TO event table id
...
CREATE TABLE multi_results (  -- keeping this table, as multiple athletes can refer to a single performance (relays)
    athlete_id integer, --REFERS TO table athletes table id
    performance_id integer, -- REFERS TO performances table id 
    school_id integer, -- REFERS TO schools table id
    event_id integer, -- REFERS TO event table id
